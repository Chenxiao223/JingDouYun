 ...
 */
public class CompanyCoordinatesActivity extends Activity implements OnGetGeoCoderResultListener {
    GeoCoder mSearch = null; // 搜索模块，也可去掉地图模块独立使用
    BaiduMap mBaiduMap = null;
    MapView mMapView = null;
    Button reversegeocode;

    private   String    lat="31.210844";
    private   String    lon="121.601272";
    private Intent mIntent;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_company_coordinates);
        ...
        mIntent = getIntent();
        String lan = mIntent.getStringExtra(Constants.KEY_LAT);
        String lon = mIntent.getStringExtra(Constants.KEY_LON);
        setLocation(lan,lon);
//        reversegeocode.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                reversegeocode.performClick();
...
//        });
    ...
    public void searchButtonProcess(View v) {
        if (v.getId() == R.id.reversegeocode) {
            EditText lat = (EditText) findViewById(R.id.lat);
            EditText lon = (EditText) findViewById(R.id.lon);
            String latNum = lat.getText().toString().trim();
            String lonNum = lon.getText().toString().trim();
    ...
    public void onGetGeoCodeResult(GeoCodeResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(CompanyCoordinatesActivity.this, "抱歉，未能找到结果", Toast.LENGTH_LONG)
                    .show();
            return;
        }
        mBaiduMap.clear();
        ...
        Toast.makeText(CompanyCoordinatesActivity.this, strInfo, Toast.LENGTH_LONG).show();
    }
    ...
    public void onGetReverseGeoCodeResult(ReverseGeoCodeResult result) {
        ...
        mBaiduMap.setMapStatus(MapStatusUpdateFactory.newLatLng(result
                .getLocation()));
        Toast.makeText(CompanyCoordinatesActivity.this, result.getAddress(),
